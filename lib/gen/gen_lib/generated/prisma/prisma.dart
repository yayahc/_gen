...
class StudentScheduleWhereInput
  ...
  final _i1.PrismaUnion<_i2.StringFilter, String>? classId;
...
class ClassUncheckedUpdateWithoutInstructorInput
  ...
  final _i1.PrismaUnion<String, _i2.StringFieldUpdateOperationsInput>? classId;
...
class ClassScalarWhereWithAggregatesInput
  ...
  final _i1.PrismaUnion<_i2.StringWithAggregatesFilter, String>? classId;
...
enum StudentScheduleScalar<T> implements _i1.PrismaEnum, _i1.Reference<T> {
  ...
  classId<String>('CLASS_ID', 'Student_Schedule');
...
class StudentScheduleAvgAggregateOutputType {
  const StudentScheduleAvgAggregateOutputType({this.studentId});

  factory StudentScheduleAvgAggregateOutputType.fromJson(Map json) =>
      StudentScheduleAvgAggregateOutputType(studentId: json['Student_id']);

  final double? studentId;
}

class StudentScheduleSumAggregateOutputType {
  const StudentScheduleSumAggregateOutputType({this.studentId});

  factory StudentScheduleSumAggregateOutputType.fromJson(Map json) =>
      StudentScheduleSumAggregateOutputType(studentId: json['Student_id']);
...
class StudentScheduleAvgOrderByAggregateInput
    implements _i1.JsonConvertible<Map<String, dynamic>> {
  const StudentScheduleAvgOrderByAggregateInput({this.studentId});
...
class StudentScheduleSumOrderByAggregateInput
    implements _i1.JsonConvertible<Map<String, dynamic>> {
  const StudentScheduleSumOrderByAggregateInput({this.studentId});
...
class StudentScheduleAvgAggregateOutputTypeSelect
    implements _i1.JsonConvertible<Map<String, dynamic>> {
  const StudentScheduleAvgAggregateOutputTypeSelect({this.studentId});
...
class StudentScheduleSumAggregateOutputTypeSelect
    implements _i1.JsonConvertible<Map<String, dynamic>> {
  const StudentScheduleSumAggregateOutputTypeSelect({this.studentId});
